...
public class PerlinBW extends BinaryFunction {
	...
	/**
	 * Evaluates this expression at the given x,y point by evaluating the perlinBW
	 * values of the function's parameters.
	 * 
	 * @return the color from evaluating the perlinBW values of the expression's
	 *         parameters
	 */
	@Override
	public RGBColor evaluate(double x, double y) {
		...
		double grey = ImprovedNoise.noise(result_left.getRed() + result_right.getRed(),
				result_left.getGreen() + result_right.getGreen(), result_left.getBlue() + result_right.getBlue());
