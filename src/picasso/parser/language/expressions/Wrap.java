 ...
 * This class extends UnaryFunction and represents a function that wraps color values around the range [-1, 1].
 * 
...
public class Wrap extends UnaryFunction {
	...
	/**
	 * Evaluates the wrap function on the given parameter, wrapping color values around the range [-1, 1].
	 * 
